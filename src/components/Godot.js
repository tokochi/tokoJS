...
export default function Godot(props) {
    ...
    const handleClick9 = () => {setOpen9(!open9);};
    const handleClick10 = () => {setOpen10(!open10);};
    const handleClick11 = () => {setOpen11(!open11);};
    ...
    const [Redux, setRedux] = React.useState(false);
...
<div className={classes.sideBar}><List  component="nav" aria-labelledby="nested-list-subheader"  className={classes.root}>
    ...
    <div id="JavaScript"><ListItem button onClick={handleClick}  style={{padding:0, marginLeft:5}}>{open ? <AiOutlineMinusSquare style={{color: '#C09553', fontSize:'15', marginRight:'5',padding:0}}/> : <AiOutlinePlusSquare style={{color: '#C09553', fontSize:'15', marginRight:'5',padding:0}}/>}{open ? <AiFillFolderOpen style={{color: '#C09553', fontSize:'25', marginRight:'5',padding:0}}/> : <AiFillFolder style={{color: '#C09553', fontSize:'25', marginRight:'5',padding:0}}/>}JavaScript</ListItem >
     ...
     <Collapse in={open} timeout="auto" unmountOnExit>
               ...
               <div id="item">
                        <Collapse in={open} timeout="auto" unmountOnExit>
                         <List component="div" disablePadding>
                            <ListItem button component={Link} to="/t" target="_blank" className={classes.nested} style={{paddingLeft: 40}}>
                            <img src={jsLogo} alt="Logo" height='12px'  style={{padding:0, marginRight:5}} /> {'Toolbar'}
            ...
            <Collapse in={open} timeout="auto" unmountOnExit>
               <List component="div" disablePadding>
                    ...
                    <div id="item">
                        <Collapse in={Objects} timeout="auto" unmountOnExit>
                         <List component="div" disablePadding>
                            <ListItem button onClick={() => {navigator.clipboard.writeText('let keys = Object.keys(myObject) // return new Array of keys')}}className={classes.nested} style={{paddingLeft: 40}}>
                            <img src={jsLogo} alt="Logo" height='12px'  style={{padding:0, marginRight:5}} /> {'keys to Array'}
                            <ListItemText primary="" />
                            </ListItem>
                         </List>
                        </Collapse>
                    ...
                    <div id="item">
                        <Collapse in={Objects} timeout="auto" unmountOnExit>
                         <List component="div" disablePadding>
                            <ListItem button onClick={() => {navigator.clipboard.writeText('let vals = Object.values(myObject) // return new Array of vlaues')}}className={classes.nested} style={{paddingLeft: 40}}>
                            <img src={jsLogo} alt="Logo" height='12px'  style={{padding:0, marginRight:5}} /> {'values to Array'}
                            <ListItemText primary="" />
                            </ListItem>
                         </List>
                        </Collapse>
                    ...
                    <div id="item">
                        <Collapse in={Objects} timeout="auto" unmountOnExit>
                         <List component="div" disablePadding>
                            <ListItem button onClick={() => {navigator.clipboard.writeText("let vals = Object.entries(myObject) // return new Array of multiple Arrays['key', 'value']")}}className={classes.nested} style={{paddingLeft: 40}}>
                            <img src={jsLogo} alt="Logo" height='12px'  style={{padding:0, marginRight:5}} /> {'object to Array'}
                            <ListItemText primary="" />
                            </ListItem>
                         </List>
                        </Collapse>
           ...
           <Collapse in={open7} timeout="auto" unmountOnExit>
               <List component="div" disablePadding>
                  ...
                  <div id="item">
                        <Collapse in={open7} timeout="auto" unmountOnExit>
                         <List component="div" disablePadding>
                            <ListItem button onClick={() => {navigator.clipboard.writeText("import { BrowserRouter } from 'react-router-dom'")}}className={classes.nested} style={{paddingLeft: 40}}>
                            <img src={share} alt="Logo" height='12px'  style={{padding:0, marginRight:5}} /> {'React Browser Route'}
                            <ListItemText primary="" />
                            </ListItem>
                         </List>
                        </Collapse>
                  ...
                  <div id="item">
                        <Collapse in={open7} timeout="auto" unmountOnExit>
                         <List component="div" disablePadding>
                            <ListItem button onClick={() => {navigator.clipboard.writeText("import { Link } from 'react-router-dom'")}}className={classes.nested} style={{paddingLeft: 40}}>
                            <img src={share} alt="Logo" height='12px'  style={{padding:0, marginRight:5}} /> {'React  Link'}
                            <ListItemText primary="" />
                            </ListItem>
                         </List>
                        </Collapse>
                  ...
                  <div id="item">
                        <Collapse in={open7} timeout="auto" unmountOnExit>
                         <List component="div" disablePadding>
                            <ListItem button onClick={() => {navigator.clipboard.writeText("import bootstrap from '../node_modules/bootstrap/dist/css/bootstrap.min.css'")}}className={classes.nested} style={{paddingLeft: 40}}>
                            <img src={share} alt="Logo" height='12px'  style={{padding:0, marginRight:5}} /> {'Bootstrap'}
                            <ListItemText primary="" />
                            </ListItem>
                         </List>
                        </Collapse>
           ...
           <Collapse in={open8} timeout="auto" unmountOnExit>
               <List component="div" disablePadding>
                  <div id="item">
                        <Collapse in={open8} timeout="auto" unmountOnExit>
                         <List component="div" disablePadding>
                            ...
                            <img src={gitLogo} alt="Logo" height='12px'  style={{padding:0, marginRight:5}} /> {'Init repository'}
                            <ListItemText primary="" />
                            </ListItem>
                         </List>
                        </Collapse>
                  ...
                  <div id="item">
                        <Collapse in={open8} timeout="auto" unmountOnExit>
                         <List component="div" disablePadding>
                            ...
                            <img src={gitLogo} alt="Logo" height='12px'  style={{padding:0, marginRight:5}} /> {'Status'}
                            <ListItemText primary="" />
                            </ListItem>
                         </List>
                        </Collapse>
                  ...
                  <div id="item">
                        <Collapse in={open8} timeout="auto" unmountOnExit>
                         <List component="div" disablePadding>
                            <ListItem button onClick={() => {navigator.clipboard.writeText("git log --oneline --reverse")}}className={classes.nested} style={{paddingLeft: 40}}>
                            <img src={gitLogo} alt="Logo" height='12px'  style={{padding:0, marginRight:5}} /> {'History'}
                            <ListItemText primary="" />
                            </ListItem>
                         </List>
                        </Collapse>
                  ...
                  <div id="item">
                        <Collapse in={open8} timeout="auto" unmountOnExit>
                         <List component="div" disablePadding>
                            ...
                            <img src={gitLogo} alt="Logo" height='12px'  style={{padding:0, marginRight:5}} /> {'Add to Stage'}
                            <ListItemText primary="" />
                            </ListItem>
                         </List>
                        </Collapse>
                  ...
                  <div id="item">
                        <Collapse in={open8} timeout="auto" unmountOnExit>
                         <List component="div" disablePadding>
                            ...
                            <img src={gitLogo} alt="Logo" height='12px'  style={{padding:0, marginRight:5}} /> {'Add commit'}
                            <ListItemText primary="" />
                            </ListItem>
                         </List>
                        </Collapse>
                  ...
                  <div id="item">
                        <Collapse in={open8} timeout="auto" unmountOnExit>
                         <List component="div" disablePadding>
                            ...
                            <img src={gitLogo} alt="Logo" height='12px'  style={{padding:0, marginRight:5}} /> {'Delete files'}
                            <ListItemText primary="" />
                            </ListItem>
                         </List>
                        </Collapse>
                  ...
                  <div id="item">
                        <Collapse in={open8} timeout="auto" unmountOnExit>
                         <List component="div" disablePadding>
                            ...
                            <img src={gitLogo} alt="Logo" height='12px'  style={{padding:0, marginRight:5}} /> {'Delete from stage'}
                            <ListItemText primary="" />
                            </ListItem>
                         </List>
                        </Collapse>
                  ...
                  <div id="item">
                        <Collapse in={open8} timeout="auto" unmountOnExit>
                         <List component="div" disablePadding>
                            ...
                            <img src={gitLogo} alt="Logo" height='12px'  style={{padding:0, marginRight:5}} /> {'Rename files'}
                            <ListItemText primary="" />
                            </ListItem>
                         </List>
                        </Collapse>
                  ...
                  <div id="item">
                        <Collapse in={open8} timeout="auto" unmountOnExit>
                         <List component="div" disablePadding>
                            <ListItem button onClick={() => {navigator.clipboard.writeText("git branch name")}}className={classes.nested} style={{paddingLeft: 40}}>
                            <img src={gitLogo} alt="Logo" height='12px'  style={{padding:0, marginRight:5}} /> {'Add branch'}
                            <ListItemText primary="" />
                            </ListItem>
                         </List>
                        </Collapse>
                  ...
                  <div id="item">
                        <Collapse in={open8} timeout="auto" unmountOnExit>
                         <List component="div" disablePadding>
                            <ListItem button onClick={() => {navigator.clipboard.writeText("git branch branchname")}}className={classes.nested} style={{paddingLeft: 40}}>
                            <img src={gitLogo} alt="Logo" height='12px'  style={{padding:0, marginRight:5}} /> {'branchs List'}
                            <ListItemText primary="" />
                            </ListItem>
                         </List>
                        </Collapse>
                  ...
                  <div id="item">
                        <Collapse in={open8} timeout="auto" unmountOnExit>
                         <List component="div" disablePadding>
                            <ListItem button onClick={() => {navigator.clipboard.writeText("git switch branchname")}}className={classes.nested} style={{paddingLeft: 40}}>
                            <img src={gitLogo} alt="Logo" height='12px'  style={{padding:0, marginRight:5}} /> {'branchs switch'}
                            <ListItemText primary="" />
                            </ListItem>
                         </List>
                        </Collapse>
                  ...
                  <div id="item">
                        <Collapse in={open8} timeout="auto" unmountOnExit>
                         <List component="div" disablePadding>
                            <ListItem button onClick={() => {navigator.clipboard.writeText("git remote -v")}}className={classes.nested} style={{paddingLeft: 40}}>
                            <img src={gitLogo} alt="Logo" height='12px'  style={{padding:0, marginRight:5}} /> {'remote List'}
                            <ListItemText primary="" />
                            </ListItem>
                         </List>
                        </Collapse>
                  ...
                  <div id="item">
                        <Collapse in={open8} timeout="auto" unmountOnExit>
                         <List component="div" disablePadding>
                            <ListItem button onClick={() => {navigator.clipboard.writeText("git add origin url")}}className={classes.nested} style={{paddingLeft: 40}}>
                            <img src={gitLogo} alt="Logo" height='12px'  style={{padding:0, marginRight:5}} /> {'Add remote'}
                            <ListItemText primary="" />
                            </ListItem>
                         </List>
                        </Collapse>
                  ...
                  <div id="item">
                        <Collapse in={open8} timeout="auto" unmountOnExit>
                         <List component="div" disablePadding>
                            <ListItem button onClick={() => {navigator.clipboard.writeText("git switch branchname")}}className={classes.nested} style={{paddingLeft: 40}}>
                            <img src={gitLogo} alt="Logo" height='12px'  style={{padding:0, marginRight:5}} /> {'Remove remote'}
                            <ListItemText primary="" />
                            </ListItem>
                         </List>
                        </Collapse>
                  ...
                  <div id="item">
                        <Collapse in={open8} timeout="auto" unmountOnExit>
                         <List component="div" disablePadding>
                            <ListItem button onClick={() => {navigator.clipboard.writeText("git push -u origin main")}}className={classes.nested} style={{paddingLeft: 40}}>
                            <img src={gitLogo} alt="Logo" height='12px'  style={{padding:0, marginRight:5}} /> {'Push'}
                            <ListItemText primary="" />
                            </ListItem>
                         </List>
                        </Collapse>
      ...
      <div id="Axios">
            <Collapse in={open1} timeout="auto" unmountOnExit>
               ...
               <div id="delete request">
                        <Collapse in={open1} timeout="auto" unmountOnExit>
                         <List component="div" disablePadding>
                            <ListItem button onClick={() => {navigator.clipboard.writeText("npm install --force")}}className={classes.nested} style={{paddingLeft: 40}}>
                    ...
                    <div id="delete request">
                        <Collapse in={open1} timeout="auto" unmountOnExit>
                         <List component="div" disablePadding>
                            <ListItem button onClick={() => {navigator.clipboard.writeText("npm update")}}className={classes.nested} style={{paddingLeft: 40}}>
                            <img src={npmLogo} alt="Logo" height='12px'  style={{padding:0, marginRight:5}} /> {'Update'}
                            <ListItemText primary="" />
                            </ListItem>
                         </List>
                        </Collapse>
                    ...
                    <div id="delete request">
                        <Collapse in={open1} timeout="auto" unmountOnExit>
                         <List component="div" disablePadding>
                            <ListItem button onClick={() => {navigator.clipboard.writeText("npm audit fix --force")}}className={classes.nested} style={{paddingLeft: 40}}>
                            <img src={npmLogo} alt="Logo" height='12px'  style={{padding:0, marginRight:5}} /> {'Audit fix'}
                            <ListItemText primary="" />
                            </ListItem>
                         </List>
                        </Collapse>
                  ...
                  <div id="delete request">
                        <Collapse in={open1} timeout="auto" unmountOnExit>
                         <List component="div" disablePadding>
                            <ListItem button onClick={() => {navigator.clipboard.writeText("npm i react-router-dom")}}className={classes.nested} style={{paddingLeft: 40}}>
                            <img src={npmLogo} alt="Logo" height='12px'  style={{padding:0, marginRight:5}} /> {'React Router'}
                            <ListItemText primary="" />
                            </ListItem>
                         </List>
                        </Collapse>
   ...
   {/* // ----> ReactJS    */}
      <div id="ReactJS"><ListItem button onClick={handleClick2}  style={{padding:0, marginLeft:5}}>{open2 ? <AiOutlineMinusSquare style={{color: '#C09553', fontSize:'15', marginRight:'5',padding:0}}/> : <AiOutlinePlusSquare style={{color: '#C09553', fontSize:'15', marginRight:'5',padding:0}}/>}{open2 ? <AiFillFolderOpen style={{color: '#C09553', fontSize:'25', marginRight:'5',padding:0}}/> : <AiFillFolder style={{color: '#C09553', fontSize:'25', marginRight:'5',padding:0}}/>}React JS</ListItem >
      <div id="ReactJS">
            <Collapse in={open2} timeout="auto" unmountOnExit>
               <List component="div" disablePadding>
               <ListItem button onClick={(e) => {e.stopPropagation();setRedux(!Redux)}}  style={{padding:0, marginLeft:5}}>
                         {Redux ? <AiOutlineMinusSquare style={{color: '#C09553', fontSize:'15', margin:'0 0 0 15',padding:0}}/> : <AiOutlinePlusSquare style={{color: '#C09553', fontSize:'15', margin:'0 0 0 15',padding:0}}/>}
                         {Redux ? <AiFillFolderOpen style={{color: '#C09553', fontSize:'25', marginRight:'5',padding:0}}/> : <AiFillFolder style={{color: '#C09553', fontSize:'25', marginRight:'5',padding:0}}/>}
                         ReduxToolkit
                     </ListItem >
                     <div id="item">
                        <Collapse in={Redux} timeout="auto" unmountOnExit>
                         <List component="div" disablePadding>
                            <ListItem button onClick={() => {navigator.clipboard.writeText('npm install @reduxjs/toolkit react-redux')}}className={classes.nested} style={{paddingLeft: 40}}>
                            <img src={reduxLogo} alt="Logo" height='12px'  style={{padding:0, marginRight:5}} /> {'NPM Install'}
                            <ListItemText primary="" />
                            </ListItem>
                         </List>
                        </Collapse></div>
                    <div id="item">
                        <Collapse in={Redux} timeout="auto" unmountOnExit>
                         <List component="div" disablePadding>
                            <ListItem button onClick={() => {navigator.clipboard.writeText("npx create-react-app my-app --template redux")}}className={classes.nested} style={{paddingLeft: 40}}>
                            <img src={reduxLogo} alt="Logo" height='12px'  style={{padding:0, marginRight:5}} /> {'CRA Template Redux'}
                            <ListItemText primary="" />
                            </ListItem>
                         </List>
                        </Collapse>
                    ...
                    <div id="item">
                        <Collapse in={Redux} timeout="auto" unmountOnExit>
                         <List component="div" disablePadding>
                            <ListItem button onClick={() => {navigator.clipboard.writeText("import { configureStore } from '@reduxjs/toolkit';\nimport Reducer1 from './Reducer1';\nconst reducer = {todos: Reducer1};\nexport default store = configureStore({ reducer })\n")}}className={classes.nested} style={{paddingLeft: 40}}>
                            <img src={reduxLogo} alt="Logo" height='12px'  style={{padding:0, marginRight:5}} /> {'Create Store'}
                            <ListItemText primary="" />
                            </ListItem>
                         </List>
                        </Collapse>
                    ...
                    <div id="item">
                        <Collapse in={Redux} timeout="auto" unmountOnExit>
                         <List component="div" disablePadding>
                            <ListItem button onClick={() => {navigator.clipboard.writeText("")}}className={classes.nested} style={{paddingLeft: 40}}>
                            <img src={reduxLogo} alt="Logo" height='12px'  style={{padding:0, marginRight:5}} /> {'Create Action'}
                            <ListItemText primary="" />
                            </ListItem>
                         </List>
                        </Collapse>
                    ...
                    <div id="item">
                        <Collapse in={Redux} timeout="auto" unmountOnExit>
                         <List component="div" disablePadding>
                            <ListItem button onClick={() => {navigator.clipboard.writeText("npx create-react-app my-app --template redux")}}className={classes.nested} style={{paddingLeft: 40}}>
                            <img src={reduxLogo} alt="Logo" height='12px'  style={{padding:0, marginRight:5}} /> {'Create Reducer'}
                            <ListItemText primary="" />
                            </ListItem>
                         </List>
                        </Collapse>
                    ...
                    <div id="item">
                        <Collapse in={Redux} timeout="auto" unmountOnExit>
                         <List component="div" disablePadding>
                            <ListItem button onClick={() => {navigator.clipboard.writeText("npx create-react-app my-app --template redux")}}className={classes.nested} style={{paddingLeft: 40}}>
                            <img src={reduxLogo} alt="Logo" height='12px'  style={{padding:0, marginRight:5}} /> {'Create Slice'}
                            <ListItemText primary="" />
                            </ListItem>
                         </List>
                        </Collapse>
               ...
               <div id="item">
                     <Collapse in={open2} timeout="auto" unmountOnExit>
                         <List component="div" disablePadding>
                            <ListItem button onClick={() => {navigator.clipboard.writeText("npx create-react-app . // a tool from React team to build app quickly auto config weback + bibel")}}className={classes.nested} style={{paddingLeft: 40}}>
                            <img src={reactLogo} alt="Logo" height='12px'  style={{padding:0, marginRight:5}} /> {'Create React App'}
                            <ListItemText primary="" />
                            </ListItem>
                         </List>
                     </Collapse>
               ...
               <div id="item">
                     <Collapse in={open2} timeout="auto" unmountOnExit>
                         <List component="div" disablePadding>
                            <ListItem button onClick={() => {navigator.clipboard.writeText("<Route exact path='' component={}/>")}}className={classes.nested} style={{paddingLeft: 40}}>
                            <img src={reactLogo} alt="Logo" height='12px'  style={{padding:0, marginRight:5}} /> {'new Route'}
                            <ListItemText primary="" />
                            </ListItem>
                         </List>
                      </Collapse>
               ...
               <div id="item">
                     <Collapse in={open2} timeout="auto" unmountOnExit>
                         <List component="div" disablePadding>
                            <ListItem button onClick={() => {navigator.clipboard.writeText("<Link to='' ></Link>")}}className={classes.nested} style={{paddingLeft: 40}}>
                            <img src={reactLogo} alt="Logo" height='12px'  style={{padding:0, marginRight:5}} /> {'new Link'}
                            <ListItemText primary="" />
                            </ListItem>
                         </List>
                      </Collapse>
               ...
               <div id="item">
                     <Collapse in={open2} timeout="auto" unmountOnExit>
                         <List component="div" disablePadding>
                            <ListItem button onClick={() => {navigator.clipboard.writeText("const [State, setState] = useState();")}}className={classes.nested} style={{paddingLeft: 40}}>
                            <img src={reactLogo} alt="Logo" height='12px'  style={{padding:0, marginRight:5}} /> {'useState'}
                            <ListItemText primary="" />
                            </ListItem>
                         </List>
                      </Collapse>
               ...
               <div id="item">
                     <Collapse in={open2} timeout="auto" unmountOnExit>
                         <List component="div" disablePadding>
                            <ListItem button onClick={() => {navigator.clipboard.writeText("useEffect(() => {\n    effect\n    return () => {\n        cleanup\n    }\n}, [input])")}}className={classes.nested} style={{paddingLeft: 40}}>
                            <img src={reactLogo} alt="Logo" height='12px'  style={{padding:0, marginRight:5}} /> {'useEffect'}
                            <ListItemText primary="" />
                            </ListItem>
                         </List>
                      </Collapse>
               ...
               <div id="item">
                     <Collapse in={open2} timeout="auto" unmountOnExit>
                         <List component="div" disablePadding>
                            <ListItem button onClick={() => {navigator.clipboard.writeText("const Mycontext = createContext(object) // context Object with initial value \n<Mycontext.Provider value={object.value}>\n    <component/>\n</Mycontext.Provider>\nfunction component (){\n    const consumeValue = useContext(Mycontext);\n}")}}className={classes.nested} style={{paddingLeft: 40}}>
                            <img src={reactLogo} alt="Logo" height='12px'  style={{padding:0, marginRight:5}} /> {'useContext'}
                            <ListItemText primary="" />
                            </ListItem>
                         </List>
                      </Collapse>
               ...
               <div id="item">
                     <Collapse in={open2} timeout="auto" unmountOnExit>
                         <List component="div" disablePadding>
                            <ListItem button onClick={() => {navigator.clipboard.writeText("const myBtn = useRef(0); // store referance of DOM element\n<button ref={myBtn} ></button>")}}className={classes.nested} style={{paddingLeft: 40}}>
                            <img src={reactLogo} alt="Logo" height='12px'  style={{padding:0, marginRight:5}} /> {'useRef'}
                            <ListItemText primary="" />
                            </ListItem>
                         </List>
                      </Collapse>
               ...
               <div id="item">
                     <Collapse in={open2} timeout="auto" unmountOnExit>
                         <List component="div" disablePadding>
                            <ListItem button onClick={() => {navigator.clipboard.writeText("const [state, dispatch] = useReducer(reducer, initialState)\ndispatch({type:''})\nreducer(state, action){\n  switch (action.type) {\n	 case 'Banana':\n     return;\n     case 'Orange':\n     return;\n     default:\n     return state;\n    }\n}")}}className={classes.nested} style={{paddingLeft: 40}}>
                            <img src={reactLogo} alt="Logo" height='12px'  style={{padding:0, marginRight:5}} /> {'useReducer'}
                            <ListItemText primary="" />
                            </ListItem>
                         </List>
                      </Collapse>
               ...
               <div id="item">
                     <Collapse in={open2} timeout="auto" unmountOnExit>
                         <List component="div" disablePadding>
                            <ListItem button onClick={() => {navigator.clipboard.writeText("// BROWSER=chrome\n// BROWSER_ARGS=\n// HOST=localhost\n// PORT=3002\n// HTTPS=true\n// DISABLE_ESLINT_PLUGIN=true\n// DISABLE_NEW_JSX_TRANSFORM=true")}}className={classes.nested} style={{paddingLeft: 40}}>
                            <img src={reactLogo} alt="Logo" height='12px'  style={{padding:0, marginRight:5}} /> {'.env'}
                            <ListItemText primary="" />
                            </ListItem>
                         </List>
                      </Collapse>
   ...
   {/* // ----> MongoDB    */}      
    <div id="MongoDB"><ListItem button onClick={handleClick5}  style={{padding:0, marginLeft:5}}>{open5 ? <AiOutlineMinusSquare style={{color: '#C09553', fontSize:'15', marginRight:'5',padding:0}}/> : <AiOutlinePlusSquare style={{color: '#C09553', fontSize:'15', marginRight:'5',padding:0}}/>}{open5 ? <AiFillFolderOpen style={{color: '#C09553', fontSize:'25', marginRight:'5',padding:0}}/> : <AiFillFolder style={{color: '#C09553', fontSize:'25', marginRight:'5',padding:0}}/>}MongoDB</ListItem >
      <div id="Axios">
   ...
   {/* // ----> CSS        */}    
      <div id="CSS"><ListItem button onClick={handleClick4}  style={{padding:0, marginLeft:5}}>{open4 ? <AiOutlineMinusSquare style={{color: '#C09553', fontSize:'15', marginRight:'5',padding:0}}/> : <AiOutlinePlusSquare style={{color: '#C09553', fontSize:'15', marginRight:'5',padding:0}}/>}{open4 ? <AiFillFolderOpen style={{color: '#C09553', fontSize:'25', marginRight:'5',padding:0}}/> : <AiFillFolder style={{color: '#C09553', fontSize:'25', marginRight:'5',padding:0}}/>}CSS</ListItem >
      <div id="Axios">
   ...
   {/* // ----> HTML       */}     
    <div id="MongoDB"><ListItem button onClick={handleClick6}  style={{padding:0, marginLeft:5}}>{open6 ? <AiOutlineMinusSquare style={{color: '#C09553', fontSize:'15', marginRight:'5',padding:0}}/> : <AiOutlinePlusSquare style={{color: '#C09553', fontSize:'15', marginRight:'5',padding:0}}/>}{open6 ? <AiFillFolderOpen style={{color: '#C09553', fontSize:'25', marginRight:'5',padding:0}}/> : <AiFillFolder style={{color: '#C09553', fontSize:'25', marginRight:'5',padding:0}}/>}HTML</ListItem >
      <div id="Head import">
            <Collapse in={open6} timeout="auto" unmountOnExit>
               ...
               <div id="item">
                        <Collapse in={open6} timeout="auto" unmountOnExit>
                         <List component="div" disablePadding>
                            <ListItem button onClick={() => {navigator.clipboard.writeText("<link rel='stylesheet' href='./style.css'>")}}className={classes.nested} style={{paddingLeft: 40}}>
                            <img src={npmLogo} alt="Logo" height='12px'  style={{padding:0, marginRight:5}} /> {'Style'}
                            <ListItemText primary="" />
                            </ListItem>
                         </List>
                        </Collapse>
                    ...
                    <div id="item">
                        <Collapse in={open6} timeout="auto" unmountOnExit>
                         <List component="div" disablePadding>
                            <ListItem button onClick={() => {navigator.clipboard.writeText("<script src='./index.js'>")}}className={classes.nested} style={{paddingLeft: 40}}>
                            <img src={npmLogo} alt="Logo" height='12px'  style={{padding:0, marginRight:5}} /> {'Script'}
                            <ListItemText primary="" />
                            </ListItem>
                         </List>
                        </Collapse>
   ...
   {/* // ----> BootStrap  */}     
     <div id="BootStrap"><ListItem button onClick={handleClick9}  style={{padding:0, marginLeft:5}}>{open9 ? <AiOutlineMinusSquare style={{color: '#C09553', fontSize:'15', marginRight:'5',padding:0}}/> : <AiOutlinePlusSquare style={{color: '#C09553', fontSize:'15', marginRight:'5',padding:0}}/>}{open9 ? <AiFillFolderOpen style={{color: '#C09553', fontSize:'25', marginRight:'5',padding:0}}/> : <AiFillFolder style={{color: '#C09553', fontSize:'25', marginRight:'5',padding:0}}/>}BootStrap</ListItem >
      <div id="Axios">
            <Collapse in={open9} timeout="auto" unmountOnExit>
               ...
               <div id="item">
                        <Collapse in={open9} timeout="auto" unmountOnExit>
                         <List component="div" disablePadding>
                            <ListItem button onClick={() => {navigator.clipboard.writeText("npm i bootstrap")}}className={classes.nested} style={{paddingLeft: 40}}>
                            <img src={npmLogo} alt="Logo" height='12px'  style={{padding:0, marginRight:5}} /> {'NPM install'}
                            <ListItemText primary="" />
                            </ListItem>
                         </List>
                        </Collapse>
                  ...
                  <div id="item">
                        <Collapse in={open9} timeout="auto" unmountOnExit>
                         <List component="div" disablePadding>
                            <ListItem button onClick={() => {navigator.clipboard.writeText("html, body {\n    min-height: 100% !important;\n    max-width: auto;\n    background-size: cover;\n}")}}className={classes.nested} style={{paddingLeft: 40}}>
                            <img src={npmLogo} alt="Logo" height='12px'  style={{padding:0, marginRight:5}} /> {'Always Add this'}
                            <ListItemText primary="" />
                            </ListItem>
                         </List>
                        </Collapse>
   ...
   {/* // ----> Electron  */}     
       <div id="Electron"><ListItem button onClick={handleClick10}  style={{padding:0, marginLeft:5}}>{open10 ? <AiOutlineMinusSquare style={{color: '#C09553', fontSize:'15', marginRight:'5',padding:0}}/> : <AiOutlinePlusSquare style={{color: '#C09553', fontSize:'15', marginRight:'5',padding:0}}/>}{open10 ? <AiFillFolderOpen style={{color: '#C09553', fontSize:'25', marginRight:'5',padding:0}}/> : <AiFillFolder style={{color: '#C09553', fontSize:'25', marginRight:'5',padding:0}}/>}Electron</ListItem >
       <div id="Electron">
   ...
   {/* // ----> Terminal  */}     
     <div id="Terminal"><ListItem button onClick={handleClick11}  style={{padding:0, marginLeft:5}}>{open11 ? <AiOutlineMinusSquare style={{color: '#C09553', fontSize:'15', marginRight:'5',padding:0}}/> : <AiOutlinePlusSquare style={{color: '#C09553', fontSize:'15', marginRight:'5',padding:0}}/>}{open11 ? <AiFillFolderOpen style={{color: '#C09553', fontSize:'25', marginRight:'5',padding:0}}/> : <AiFillFolder style={{color: '#C09553', fontSize:'25', marginRight:'5',padding:0}}/>}Terminal</ListItem >
      <div id="Terminal">
